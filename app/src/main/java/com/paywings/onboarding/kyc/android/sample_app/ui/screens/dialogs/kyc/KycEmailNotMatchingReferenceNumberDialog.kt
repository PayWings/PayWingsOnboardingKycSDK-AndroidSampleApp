...
@Composable
fun Preview_KycEmailNotMatchingReferenceNumberDialog() {
    val kycEmailNotMatchingReferenceNumberDialogState = rememberMaterialDialogState(initialValue = true)
...
@Composable
fun KycEmailNotMatchingReferenceNumberDialog(
    ...
    MaterialDialog(
        ...
        KycEmailNotMatchingReferenceNumberDialogContent()
    }
}

@Composable
private fun KycEmailNotMatchingReferenceNumberDialogContent(){
    Column(modifier = Modifier
        .fillMaxWidth()
        .padding(all = MaterialTheme.shapes.dialogEdgeDefaultPadding)) {
        ScreenTitle(
            modifier = Modifier.align(alignment = Alignment.CenterHorizontally),
            stringResId = R.string.kyc_email_not_matching_reference_number_dialog_title
        )
        SpacerDialogTitleBody()
        Text(
            style = MaterialTheme.typography.bodyMedium,
            text = stringResource(id = R.string.kyc_email_not_matching_reference_number_dialog_description)
        )
    }
}